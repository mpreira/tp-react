      ...
      <div className="card flex-fill">
        <div className="card-body card_container">
          ...
          <p className="flex-row d-flex justify-content-center align-items-center btn-group-horizontal">
            <button onClick={this.increment} className="mr-2 btn btn-primary">
              +
            </button>
            {quantity}
            <button onClick={this.decrement} className="ml-2 btn btn-primary">
              -
            </button>
          </p>
          <p>Prix final : {prixFinal} euros</p>
          <button onClick={this.reset} className="btn btn-warning mb-3">
            Reset
          </button>
          {this.props.panier && (
            <button onClick={this.addToShop} className="btn btn-primary">
              Ajouter au panier
            </button>
          )}
        </div>
